...
const One_Text_Image = ({ title, subtitle, paragraph, imageSource }) => {
  return (
    <div className='flex flex-col md:flex-row md:justify-between items-center  w-full px-2 m-auto my-12'> 
